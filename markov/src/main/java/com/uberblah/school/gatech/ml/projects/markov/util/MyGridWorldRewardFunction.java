 ...
 *
 */
public class MyGridWorldRewardFunction implements RewardFunction {
     ...
     */
    public MyGridWorldRewardFunction(int width, int height, double initializingReward){
     ...
     * @param height the height of the grid world
     */
    public MyGridWorldRewardFunction(int width, int height){
        this(width, height, 0.);
    }
